          ...
          <div className="space-y-2 mb-4">
            ...
            {sets.map((set, index) => (
              <div key={index} className="flex gap-2">
                ...
                {/* REPS INPUT WRAPPER (FIXED: Added flex-1 div wrapper so it splits space evenly) */}
      ...
      {mode === 'cardio' && (
        <div className="bg-zinc-900 p-4 rounded-lg border border-zinc-800 animate-fade-in">
          ...
          <div className="flex gap-3 mb-6">
            ...
            <div className="flex-1 min-w-0"><label className="text-[10px] text-zinc-500 uppercase font-bold block mb-1">Distance (opt)</label><input type="number" value={cardioDistance} onChange={(e) => setCardioDistance(e.target.value)} className="w-full bg-black border border-zinc-700 rounded p-2 text-white outline-none" placeholder="-" /></div>
          </div>
