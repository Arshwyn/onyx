...
export default function DailyView() {
  ...
  const loadView = async (targetDate, showLoading = true) => {
    try {
        ...
        if (routine) {
            ...
            // History Stats (Last Performance)
            const historyStats = {};
            mergedData.forEach(ex => {
  ...
  return (
    <div className="w-full max-w-md mx-auto text-white pb-20 overflow-x-hidden">
      ...
      {showCardioForm && (
        <div className="bg-zinc-900 border border-zinc-800 p-4 rounded-lg animate-fade-in mb-8">
