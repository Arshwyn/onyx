...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-blue-500/30 flex flex-col">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-black/95 backdrop-blur-md border-t border-zinc-900 safe-area-pb z-50">
...
function NavButton({ active, onClick, icon, label }) {
    ...
    return (
      <button onClick={onClick} className={`flex flex-col items-center justify-center gap-1.5 transition-all duration-300 group flex-shrink-0 w-16 ${active ? 'text-white scale-105' : 'text-zinc-600 hover:text-zinc-400'}`}>
